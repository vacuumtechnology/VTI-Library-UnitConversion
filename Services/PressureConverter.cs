...
namespace VtiUnitConversion.Services
{
    public class PressureConverter : IPressureConverter
    {
        ...
        public PressureConverter()
        {
            ...
            AddConversions(PressureUnit.Torr, v => (v + 14.69593m) / 0.0019336775m, v => (v * 0.0019336775m) - 14.69593m);
            AddConversions(PressureUnit.Micron, v => (v + 14.69593m) / 0.0019336775m * 1000m, v => (v / 1000m * 0.0019336775m) - 14.69593m);
            ...
            AddConversions(PressureUnit.MbarG, v => v / 0.0145037738m, v => v * 0.0145037738m);
            AddConversions(PressureUnit.MbarAbs, v => (v + 14.69593m) / 0.0145037738m, v => (v * 0.0145037738m) - 14.69593m);
            ...
            AddDoubleConversions(PressureUnit.Torr, v => (v + 14.69593d) / 0.0019336775d, v => (v * 0.0019336775d) - 14.69593d);
            AddDoubleConversions(PressureUnit.Micron, v => (v + 14.69593d) / 0.0019336775d * 1000d, v => (v / 1000d * 0.0019336775d) - 14.69593d);
            ...
            AddDoubleConversions(PressureUnit.MbarG, v => v / 0.0145037738d, v => v * 0.0145037738d);
            AddDoubleConversions(PressureUnit.MbarAbs, v => (v + 14.69593d) / 0.0145037738d, v => (v * 0.0145037738d) - 14.69593d);
